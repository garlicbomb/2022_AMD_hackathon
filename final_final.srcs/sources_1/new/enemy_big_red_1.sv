   ...
   // assign shoot_control = shoot;
    ...
    localparam [0:3][2:0][7:0] palette_colors =  { // Color table , 4(color) * 3 (R,G,B) * 8bit(0~255) // 4행 3열 data, 각 pixel 은 8bit 
       // R      G       B // 
        ...
        8'hFF, 8'hFF, 8'h21,    // R - 255, G - 255, B - 33 : Yellow -> hexadecimal : FF FF 21  ===> YELLOW : 4'd2(죽어야 하는 뱅기 표시)
    ...
    assign sprite_hit_x = (i_x >= sprite_x) && (i_x < sprite_x + 236) && (notcollision ==1) && (hit_sig == 1);   // sprite_hit_x = 1 when spirte_x <= i_x < sprite_x + 64
    assign sprite_hit_y = (i_y >= sprite_y) && (i_y < sprite_y + 116) && (notcollision ==1) && (hit_sig == 1);   // sprite_hit_y = 1 when spirte_y <= i_y < sprite_y + 64
    ...
    /////////////////////////////////////////// modified ////////////////////////////////////////////////////////////////////////////////////
     initial begin
        sprite_x <= 16'd640 - 16'd190; // 1280 가로의 중간인 640 에서 적들 5개 이미지의 1/2 값인 190을 뺌
        //-> 적들이 가운데에 위치할 수 있도록 
    ...
    if(hit_sig==1) begin
       sprite_y <= sprite_y+1;        // 움직임을 위한 setting, y축에서 1의 속도로 내려옴
       sprite_x <= sprite_x; 
            ...
            else if (sprite_y == 16'd720) begin
                sprite_x <= 16'd640 - 16'd190;
                sprite_y <= 16'd0;
                end   
            end
