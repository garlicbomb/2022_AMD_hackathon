...
module sprite_compositor_score_3( // score를 위한 모듈 
   ...
   localparam [0:8][0:38][3:0] sprite_data = {  
    ...
    4'd0,4'd0,4'd0,4'd0,4'd2,4'd0,4'd2,4'd2,4'd0,4'd0,4'd2,4'd0,4'd2,4'd0,4'd2,4'd0, 4'd0,4'd0,4'd2,4'd0,4'd0,4'd0,4'd2,4'd0,4'd0,4'd0,4'd0,4'd2,4'd0,4'd0,4'd0,4'd0,4'd0,4'd0,4'd0,4'd0,4'd0,4'd0,4'd0,
