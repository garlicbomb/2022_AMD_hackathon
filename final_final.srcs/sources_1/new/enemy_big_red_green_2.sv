module enemy_big_red_green_2( //보호하는 친구1, 총을 쏴야함
    ...
    /////////////////////////////////////////// modified ////////////////////////////////////////////////////////////////////////////////////
     initial begin
        sprite_x <= 16'd640 - 16'd150; // 1280 가로의 중간인 640 에서 적들 5개 이미지의 1/2 값인 190을 뺌
        //-> 적들이 가운데에 위치할 수 있도록 
        ...
        if(hit_sig==1) begin
            ...
            sprite_x <= sprite_x; 
                ...
                if (sprite_y == 16'd288) begin
                    ...
                    sprite_y <= sprite_y;
                    if (sprite_x == 16'd640 - 16'd150 + 16'd490)
                        sprite_x_direction <=1;
                    else if (sprite_x == 16'd640 - 16'd150 - 16'd490)
