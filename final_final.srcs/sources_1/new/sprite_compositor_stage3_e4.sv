...
module sprite_compositor_stage3_e4(//오른쪽 대각선으로 내려오는 enemy
    ...
    if(hit_sig==1) begin
       sprite_y <= sprite_y+2;        // 움직임을 위한 setting, y축에서 1의 속도로 내려옴, x축에서 2의 속도로 오른쪽으로감
       sprite_x <= sprite_x+3; 
            ...
            else if (sprite_y == 16'd720 || sprite_x == 16'd1280) begin
                sprite_x <= -16'd64;
                sprite_y <= 16'd0;
                end   
            end
