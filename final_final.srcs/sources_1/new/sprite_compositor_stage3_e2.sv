...
module sprite_compositor_stage3_e2(//위로 올라가는 enemy
    ...
    /////////////////////////////////////////// modified ////////////////////////////////////////////////////////////////////////////////////
     initial begin
        ...
        //-> 적들이 가운데에 위치할 수 있도록 
        sprite_y <= 16'd720;           // y축은 위에서 720 값만큼 내려온 상태 
    ...
    if(hit_sig==1) begin
       sprite_y <= sprite_y-2;        // 움직임을 위한 setting, y축에서 1의 속도로 올라감
       sprite_x <= sprite_x; 
