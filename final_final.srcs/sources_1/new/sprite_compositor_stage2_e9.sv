...
module sprite_compositor_stage2_e9(
   ...
   output wire shoot_control        // 총을 발사하라는 신호를 총알 module에 전달 
    ...
    /////////////////////////////////////////// modified ////////////////////////////////////////////////////////////////////////////////////
     initial begin
        sprite_x <= 16'd800; // 초기값 설정 
        //-> 적들이 가운데에 위치할 수 있도록 
        sprite_y <= 16'd100;           // y축은 위에서 144 값만큼 내려온 상태 
    end
    
    ...
    always @(posedge i_v_sync) begin    // 적기가 총알에 부딪히는지 검사, notcollision signal을 발생시킴
      if (hit_sig == 1 && (notcollision == 1)) begin
        ...
        sprite_y <= sprite_y + (sprite_y_direction ? 2 : -2);
        if (sprite_y == 100) begin
            sprite_x_direction <= 1;
            sprite_y_direction <= 1; end
